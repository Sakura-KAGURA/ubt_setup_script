...
wget --no-check-certificate https://github.com/Sakura-KAGURA/ubt_setup_script/archive/master.tar.gz -O ubt_setup_script-master.tar.gz

tar xzvf ubt_setup_script-master.tar.gz
...
rm  ubt_setup_script-master.tar.gz
